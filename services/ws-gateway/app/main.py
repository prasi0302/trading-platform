        ...
        if client_id:
            ...
            if ws:
                try:
                    ...
                    # Client may have disconnected mid-send. Log at debug; the
                    # connection will be cleaned up by the next disconnect event.
                    logger.debug(
                        "send_to_session failed (session=%s, event=%s): %s",
