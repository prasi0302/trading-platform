...
class RedisPublisher:
    ...
    async def _try_reconnect(self) -> None:
        ...
        try:
            ...
            # Reconnect failures are expected while Redis is down. We
            # intentionally swallow the exception so the caller's hot path is
            # not blocked, but we log at debug for diagnosability.
